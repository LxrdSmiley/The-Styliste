# The Styliste — Canonical Game Design Document v8

Status: canonical product and implementation specification; creator-approved production direction
Audience: design, engineering, art, narrative, QA, analytics, and operations
Scope: solo-developer proof-of-fun, Early Game/FTUE, Alpha, Beta, Late Game, End Game, and clearly labeled deferred expansion
Revision note: v8 integrates the Collection Cycle, two-Founder-Paths/many-industry-roles model, production bridge, House Codes, recurring human relationships, reinvention, fashion-season cadence, styling and editorial interpretation, signature reveal language, sensory identity, authored world life, market positioning, community trust, and non-feature completion gates. The creator-approved production direction defines the core fantasy as building a luxury fashion empire; targets young adults; uses an aspirational-glamorous primary tone; grounds the world in realistic fashion systems with heightened drama; permits researched city-specific visual dialects; and establishes binding direction for Kingston, Luxe, Vex, Seraphine Vale, audio, and prohibited outcomes. All v7 security, fairness, solo-development, and implementation-wave constraints remain binding.

Companion production authorities:
...
Where a companion bible conflicts with this document, this GDD controls product scope, gameplay authority, fairness, security, and release staging. Creator-approved decisions inside a companion bible control their named production discipline unless superseded by an approved later revision. Labeled implementation recommendations remain provisional until tested or separately approved.
...
7. [World, Fashion Cities, and Customer Segments](#7-world-fashion-cities-and-customer-segments)
...
24. [Version 7 Changelog — Historical](#24-version-7-changelog-historical)
25. [Version 8 Changelog](#25-version-8-changelog)
...
### 1.1 Core fantasy and category position

The creator-approved primary player takeaway is:

> **I built my own luxury fashion empire.**

The Styliste is therefore positioned player-facing as a **luxury fashion empire simulation**. Internally,
**fashion-house strategy drama** remains a useful production description because it identifies the causal
connection among creative direction, manufacturing, commerce, relationships, rivalry, crisis, prestige,
and remembered House history.

The game is not positioned primarily as a dress-up app, generic idle tycoon, social-fashion feed,
character collector, or business spreadsheet. Those formats may exist inside the product, but the complete
fantasy is:

> Create a House. Define its point of view. Build the luxury fashion empire the world remembers.

The competitive advantage is not wardrobe volume, map size, event frequency, or numerical speed. It is
the connection between what the player designs, why it exists, how it is produced, who interprets it,
what it earns or costs, what relationships it changes, how the House expands across cities, and how that
history shapes the next season.

### 1.2 Audience, world, and emotional direction

The primary audience is **young adults**. The exact storefront age rating remains a legal, content, and
platform decision rather than an assumption in this GDD.

The world is **realistic with heightened drama**. Craftsmanship, supply chains, manufacturing, retail,
buyers, media, schools, subcultures, institutions, pricing, labor, and commercial risk remain grounded in
credible fashion-industry logic. Persistent rivals, corporate crises, critics, territorial conflict, and
cinematic presentation amplify reality without turning the game into shallow soap opera or implausible
fantasy.

The primary tone is **aspirational and glamorous**. Secondary tones are ordered as follows:

1. mature and dramatic;
2. sharp and satirical;
3. competitive and intense;
4. warm and character-led;
5. mysterious and prestigious;
6. playful and humorous;
7. relaxing and comforting.

Glamour is earned through craft, ambition, point of view, relationships, discipline, risk, and consequence.
It is not communicated through sexualization, constant gold surfaces, inflated rarity labels, manipulative
urgency, cruelty, body judgment, fake flattery, or casino-style spectacle.

### 1.3 Global cultural and visual-direction promise

The Styliste deliberately represents different cultures, backgrounds, fashion traditions, industries,
subcultures, and cities. No single city or cultural tradition is the universal standard of taste or luxury.

Production Cities may use researched visual dialects—including stylized editorial, fashion illustration,
anime influence, collage, or another approved treatment—when the treatment strengthens the city’s fashion
identity. Milan may lean toward stylized editorial presentation; Tokyo may use anime-influenced editorial
language. The player’s House, Aurelian interface, material logic, character continuity, information
hierarchy, and authoritative results remain coherent across every dialect.

City-style variation must feel authored and culturally reviewed, never like generic AI output, an asset
dump, a stereotype, or an unrelated game skin.
...
### 2.12 Aspirational glamour and earned prestige

Every major milestone should make the player feel that the House has become more visible, capable,
desirable, and culturally legible. Prestige must emerge from decisions and remembered history rather
than labels applied by the interface. Restraint is part of luxury: not every interaction is urgent,
legendary, glowing, or celebratory.

### 2.13 Two Founder Paths, many industry roles

Artisan and Architect are the two starting points of view, not the only identities the player may inhabit.
The player chooses where the House begins, not everything the House is ever allowed to become. Industry
roles create specialization, relationships, information, and tradeoffs without multiplying onboarding
classes or locking core fashion-world participation behind an irreversible choice.

### 2.14 Taste before volume

A smaller catalogue of deliberate, desirable, construction-aware fashion is preferable to a large
catalogue of generic content. Every garment, character, campaign, city, sound, line of dialogue, and
marketing image must communicate a specific authored point of view and pass cultural, technical, and
mobile-readability review.

### 2.15 Creator-approved identity boundaries

The Styliste may not become generic AI art, an asset dump, a childish dress-up title, a hypersexualized
fashion game, a casino-like monetization product, a spreadsheet-only tycoon, shallow melodrama, relentless
bleakness, heavy-handed moral lecturing, forced multiplayer labor, or an overwhelming catalogue of fake
depth. Every new production decision must preserve the creator-approved fantasy of building an aspirational,
glamorous, culturally broad, strategically credible luxury fashion empire.

## 3. Audience and Player Fantasy

### 3.1 Audience entry points

The primary audience is young adults. The experience must be mature, glamorous, legible, and culturally
curious without becoming sexually exploitative, childish, inaccessible, or dependent on prior industry
knowledge.

- Fashion designers and artists author a visual language, material philosophy, and House history.
- Tycoon and strategy players manage price, demand, suppliers, inventory, staffing, cities, risk, and
  long-term market position through visual operating feedback rather than spreadsheet-only play.
- Narrative players experience Luxe, Vex, Seraphine Vale, crises, loyalty, rivalry, and remembered choices.
- Social and competitive players read the Feed, respond to rivals, submit to the Gala, and build a
  recognizable public identity without gaining a paid competitive ceiling.
- Casual players follow clear objectives, progressive disclosure, and assisted decisions while retaining
  meaningful agency.
- Solo players receive a complete game even when multiplayer participation or population is limited.
...
### 4.1 Collection Cycle: the macro loop

The individual design and commercial loops sit inside a larger seasonal Collection Cycle:

```text
Read culture and market
→ establish a Collection Brief
→ develop coordinated designs
→ sample and revise
→ cost, source, and manufacture
→ present to buyers, stylists, media, and customers
→ commit production and distribution
→ release and observe interpretation
→ manage stock, reputation, and relationships
→ archive the collection
→ review the season and begin again
```

A collection contains a title, narrative statement, target city and audience, House Codes, signature
silhouettes, material and palette direction, hero piece, commercial anchor, experimental piece, price
architecture, production plan, retail and wholesale allocation, styling direction, ethical and cultural
posture, release calendar, and post-season review.

The Kingston proof-of-fun uses a three-look capsule rather than a full runway collection. Each look must
serve a different purpose while reading as one House statement. The Collection Cycle is the primary bridge
between Artisan authorship, Architect strategy, named industry relationships, the living world, and the
Story Archive.

### 4.2 Signature collection reveal

Every committed collection culminates in a short, skippable signature sequence that shows the garment,
House identity, human interpretation, commercial consequence, cultural consequence, Luxe debrief, Vex
verdict, and Archive record. The reveal is a core product identity and marketing surface, not a disposable
reward popup. Reduced-motion and low-resource versions must preserve all information and emotional beats.
...
### 6.5 Founder Paths versus Industry Roles

Artisan and Architect remain the only Founder Paths in the first session. They define the player’s initial
point of view, early loop, narrative identity, and first mastery curve. They are not the complete profession
catalogue.

Industry Roles are specialized functions that the player may personally direct, staff, automate, contract,
collaborate with, or encounter through NPC and player organizations. Every Founder Path may eventually
participate in every Industry Role, although information, strengths, available tradeoffs, interface framing,
and narrative interpretation may differ.

### 6.6 Industry Role taxonomy

| Industry domain | Playable or directed roles | Primary affinity | Earliest authorized wave |
|---|---|---|---|
| Creative Direction | Designer, couturier, textile developer, pattern specialist | Artisan | Early Game |
| Production | Manufacturer, atelier manager, quality controller, production planner | Architect with Artisan input | Alpha |
| Materials and Supply | Supplier, material sourcer, sustainability specialist, logistics coordinator | Architect | Early Game/Alpha |
| Commerce | Buyer, merchandiser, wholesaler, pricing strategist | Architect | Early Game/Alpha |
| Retail | Store director, retailer, franchise operator, visual merchandiser | Architect | Early Game/Alpha |
| Image and Styling | Stylist, casting director, wardrobe curator, image director | Artisan with Architect budgets | Alpha |
| Media and Communications | Editor, critic, publicist, campaign director, fashion journalist | Shared | Alpha/Later |
| Culture and Subcultures | Scene connector, collaborator, cultural researcher, community curator | Shared | Later |
| Education and Talent | School partner, mentor, recruiter, scholarship sponsor | Shared | Later |
| Institutions and Heritage | Museum liaison, archive curator, council representative, standards advocate | Shared | Later/End Game |

### 6.7 Role Mastery

Role Mastery sits beneath shared Brand Rank and beside Founder Path Mastery. It unlocks information,
negotiation approaches, production policies, relationship options, automation controls, cosmetic identity,
and alternative tradeoffs. It may not grant uncapped Hype, score, market share, idle income, territory,
or competitive multipliers.

```text
Brand Rank
├── Founder Path Mastery
│   ├── Artisan
│   └── Architect
└── Industry Role Mastery
    ├── Production
    ├── Supply
    ├── Buying
    ├── Retail
...
Each role must have a distinct decision loop, clear input and output, meaningful tradeoff, connection to
the shared brand economy, NPC fallback, earned automation path, and server-authoritative settlement where
economic or competitive. No role requires abandonment of the original Founder Path.

### 6.8 Path-specific framing of shared roles

| Role | Artisan framing | Architect framing |
|---|---|---|
| Manufacturer | Protect construction intent, fit, and quality | Control cost, capacity, deadlines, and resilience |
| Supplier | Source distinctive, ethical, or expressive materials | Negotiate volume, lead time, reliability, and substitution |
| Buyer | Present a coherent collection and meaning | Negotiate volume, terms, placement, and sell-through risk |
| Retailer | Build an immersive House environment | Optimize format, assortment, flow, and profitability |
| Stylist | Create image, character, and interpretation | Allocate campaign resources and partnership strategy |
| Media | Shape cultural interpretation and creative context | Manage timing, reach, crisis exposure, and communications |
| School | Mentor craft and discover voices | Build recruitment, training, and institutional partnerships |
| Subculture | Collaborate authentically and respect scene memory | Identify demand without extraction or manufactured authenticity |
| Institution | Preserve heritage, standards, and legitimacy | Navigate policy, access, governance, and long-term reputation |

### 6.9 Third Founder Path gate

A third Founder Path may be considered only after Artisan and Architect retention, comprehension,
replayability, and Joint Venture usage are validated. It must provide a complete causal loop that cannot
be represented as an Industry Role, staff function, specialization, or shared system. A future Curator or
Cultural Director path is research-only and remains outside the current roadmap.
...
Kingston remains the proof-of-fun reference city, the cultural and emotional home of the opening
experience, and the first proof that originality, identity, community response, and resourceful ambition
can create global authority. Its priority does not diminish Milan, Paris, London, New York, Tokyo, or later
regional fashion centers. No city is a reskin, an objectively superior endgame destination, an inferior
starter market, or a stereotype about the people who live there.

Kingston must visibly connect Jamaican music subcultures, dancehall and reggae style influence, custom
tailoring, contemporary streetwear, independent creators, local markets, district context, community
validation, collaboration, and word-of-mouth. It must avoid tourist-poster Jamaica, shallow stereotypes
about wealth, class, ethnicity, taste, or behavior, and any implication that European fashion capitals
replace or legitimize Kingston’s value.
...
#### 7.3.1 City visual dialect contract

Production Cities may use distinct researched art dialects while retaining one coherent game identity.
Initial direction includes:

- **Kingston:** cinematic cultural pulse, street-to-studio movement, music-fashion connection, custom
  tailoring, streetwear, markets, community, heat, and resourceful ambition;
- **Milan:** stylized editorial composition, sculptural tailoring, atelier precision, material industry,
  disciplined luxury, and manufacturing coordination;
- **Tokyo:** anime-influenced editorial linework, expressive silhouette, precision, subculture, technology,
  limited drops, and controlled cinematic stylization;
- **Paris:** couture and fashion-illustration influence, archival authority, atelier intimacy, and
  institutional prestige;
- **London:** experimental mixed media, education, press, subculture, collage, and creative disruption;
- **New York:** cinematic commercial editorial, vertical scale, media, celebrity styling, retail, and speed.

These are direction anchors, not permission for stereotypes or visual inconsistency. Every dialect must
preserve House Codes, stable character identity, Aurelian UI, material truth, portrait readability,
accessibility, and clear authoritative results. Cultural and local expert review is required before
production lock.
...
reachable, appropriately labeled action to open it when prerequisites are satisfied.
...
### 9.7 Playable production bridge

A garment does not move directly from approved design to sale. The production bridge is:

```text
Design approved
→ sample requested
→ sample returns with fit, cost, quality, and timing evidence
→ revise, accept, or cancel
→ choose manufacturer and production terms
→ negotiate minimum quantity and deadline
→ inspect quality and resolve substitutions or defects
→ allocate finished stock
→ release
```

Production decisions expose unit cost, minimum order quantity, lead time, construction accuracy, material
substitution, labor and supplier standards, defect risk, capacity, exclusivity, cash-flow pressure, and
reputation. Manufacturers and suppliers are recurring named counterparties with goals, constraints, memory,
and alternatives rather than anonymous modifiers. The server settles all authoritative costs, inventory,
receipts, quality states, deadlines, and ownership changes.
...
### 12.1 Luxe: personal assistant, industry insider, mascot, and The First Cut

Luxe is the player’s persistent personal assistant, fashion-industry insider, strategic guide, mascot,
and first trusted professional relationship—not merely a reward presenter or tutorial layer. Luxe owns
the canonical FTUE behavior defined in §5.1, including guidance modes, Ask Luxe, tutorial-memory state,
safe failure, path comparison, and the first-return debrief.

Luxe has an androgynous/fluid high-fashion presentation. The visual identity is Aurelian editorial:
architectural tailoring, clean lines, sculptural silhouettes, and restrained metallic or monochrome
accents. Luxe’s wardrobe may reflect the player’s House trajectory without losing Luxe’s own identity.

Luxe is supportive, competent, grounded, honest, protective of the House’s emerging identity, and
non-pushy. Luxe speaks only from verified game facts, acknowledges mistakes without humiliation, identifies
bottlenecks, and presents recoverable next steps. Luxe never acts like a salesperson or notification bot,
never makes an irreversible decision for the player, and never offers fake flattery.

Luxe Trust changes primarily through meaningful decisions, not quest volume. Luxe remembers positioning,
ethics, pricing, collaborator treatment, repeated aesthetic behavior, accessibility, control, community,
and promises. Tone and recommendations may respond to that history without inventing facts.
...
### 12.3 Vex: respected critic and persistent editorial history

Vex is an elite, respected critic whose authority comes from uncompromising standards, sharp observation,
independence, and deep industry memory—not cheap hostility, clickbait, or antagonist status.

Vex tracks originality, silhouette, construction, material execution, restraint, cultural relevance,
pricing, commercial integrity, House claims, revision, repetition, trend chasing, crisis behavior, Maison
context, and rival context. Classification and opinion shifts are server-owned and inspectable.

Vex may be scathing, blunt, witty, and unsympathetic toward weak execution, overpriced mediocrity, false
exclusivity, hypocrisy, or broken narrative promises. Criticism strictly addresses the work, price,
execution, brand claim, and industry context. Vex never attacks the player’s body, identity, intelligence,
protected characteristics, or real-world worth. When the House improves, Vex acknowledges that growth with
precise professional respect.

An optional AI service may convert structured results into short editorial prose behind a trusted boundary.
It never determines Hype, rewards, penalties, market outcomes, event placement, or moderation, and it may
not invent evidence or facts.

### 12.4 Seraphine Vale, Maison Vanta, rivalry, and Archive

Maison Vanta, founded by Seraphine Vale, is the player’s first persistent rival House. Seraphine is the
main rival and strategic foil, not a static villain. She observes player choices, adapts creative and
commercial offers, competes for Hype, market share, prestige, institutional access, and cultural attention,
and creates ongoing strategic decisions rather than unavoidable losses.

The relationship remembers the player’s ethics, pricing, positioning, crisis handling, competitive choices,
and treatment of collaborators. It may evolve into escalating conflict, grudging respect, temporary
cooperation, strategic alliance, or renewed rivalry when interests change. Seraphine retains credible
self-interest and a coherent worldview in every state.

The Story Archive stores designs, deals, crises, relationships, Seraphine and Maison Vanta actions, Gala
results, and meaningful consequences in chronological context.
...
### 12.6 The simulation runs on cohorts; the player experiences people

Customer segments remain the scalable demand model, but important outcomes must be represented through
named recurring people. Kingston begins with a small cast of loyal customers, store regulars, one buyer,
one supplier, one manufacturer, one stylist or editor, and one rival-connected industry figure.

Named people remember price changes, quality, accessibility, broken promises, delays, cultural behavior,
repeated design language, crisis responses, collaborator treatment, exclusivity, and repair attempts. Their
memories create dialogue and opportunity but never override deterministic authoritative settlement.

### 12.7 House Codes and authorship memory

The House develops mechanically legible Codes from repeated choices across silhouette, materials,
construction, palette, price philosophy, accessibility, sustainability, cultural references, risk tolerance,
distribution, customer promises, and collaborator treatment.

The system may identify an emerging signature, established House Code, coherent evolution, intentional
disruption, trend chasing, contradiction, repetition without development, or abandonment of the core
audience. Luxe, Vex, customers, buyers, rivals, and institutions may reference those patterns using actual
evidence. House Codes are descriptive and opportunity-shaping; they are not static class bonuses.

### 12.8 Cultural relationship and anti-exploitation rule

Subcultures, schools, communities, and cultural institutions are not passive resource nodes. They contain
named people, values, consent boundaries, memory, and reputation. Extractive collaboration, false
affiliation, plagiarism, unpaid creative labor, cultural appropriation, and manufactured authenticity create
persistent consequences. Authentic participation requires research, attribution, fair value exchange, and
respect for refusal.
...
### 13.2 Reinvention and comeback

The House may fall out of relevance without entering a terminal fail state. Recoverable states include a
failed collection, excess inventory, damaged supplier trust, buyer withdrawal, public backlash, creative
stagnation, brand overexposure, quality failure, store closure, cash-flow pressure, or audience abandonment.

Recovery options may include a capsule relaunch, Archive revival, accessible diffusion line, creative-lead
change, supplier replacement, public accountability, customer listening, temporary retreat, debt
restructuring, store consolidation, community collaboration, or return to founding House Codes.

A comeback must require diagnosis, sacrifice, changed behavior, and time. Premium spending cannot erase a
crisis or purchase trust. The player should be able to say what went wrong, what the House changed, who
accepted or rejected the repair, and what new identity emerged.
...
assets contribute no score. Premium visual assets are labeled as presentation-only during judging.
...
### 14.3 Fashion-season operating calendar

The world follows an abstracted, humane fashion calendar:

```text
Research Window
→ Collection Development
→ Sampling and Revision
→ Buyer and Press Preview
→ Production Commitment
→ Campaign Preparation
→ Collection Release
→ Delivery and Retail Season
→ Markdown, Reroute, or Archive Decision
→ Seasonal Review
```

The calendar creates anticipation and planning without real-time sleep disruption, mandatory daily
attendance, or stacked countdown pressure. Cities may have distinct rhythms and opportunities, but no city
is objectively mandatory. Missed windows create alternate strategies rather than account damage.

### 14.4 Styling, campaign, and editorial interpretation

Presentation affects who understands a collection and how, but it cannot repair a fundamentally weak design
or directly purchase Hype. The player may select styling, presentation identity, location, set direction,
campaign narrative, budget, publication or channel, and a priority such as reach, prestige, clarity, or
experimentation.

Presentation may change audience discovery, interpretation clarity, media framing, uncertainty, House-Code
coherence, and cultural risk. All score effects remain bounded, explainable, versioned, and server-owned.
...
A clearly labeled first-purchase Founder Pack may offer a favorable fixed bundle of Luxe Credits,
...
### 18.13 Signature reveal and visual marketing truth

The collection reveal is the game’s recurring signature image. It must use actual gameplay assets and actual
settled results. Store screenshots, trailers, advertisements, and key art may not imply garment freedom,
character fidelity, city breadth, social features, or cinematic quality absent from the live build.

The reveal sequence must communicate in one view: the collection, House identity, one human reaction, one
commercial consequence, one cultural consequence, Vex’s evidence-based verdict, Luxe’s next-step framing,
and Archive continuity.

### 18.14 Aurelian art-direction and city-dialect contract

Aurelian means editorial, material-specific, cinematic, aspirational, glamorous, mature, and controlled. It
does not mean placing gold on every surface. Garments, people, cities, stores, Atelier, UI, cinematics,
effects, and marketing follow `ART_DIRECTION_BIBLE.md`.

The world may intentionally combine stylized editorial, fashion illustration, anime influence, collage,
and other researched city-specific dialects. Tokyo may use anime-influenced editorial treatment and Milan
may use stylized editorial treatment. Shared House identity, Aurelian UI, material truth, character
continuity, and result readability prevent fragmentation.

Generic AI art, stock renders, disconnected assets, sexualized clickbait, childish dress-up aesthetics, and
unreviewed cultural shorthand are release blockers. Every major image must pass the question: **could this
belong only to The Styliste and its approved city dialect?**

### 18.15 Taste and curation authority

Every garment, campaign, character, and city asset receives fashion, construction, cultural, mobile-scale,
and distinctiveness review. Content volume never substitutes for taste. Generic stock luxury imagery,
incorrect fashion terminology, incoherent construction, interchangeable generated faces, and unreviewed
cultural references are release blockers.

### 18.16 Game feel and sensory identity

High-frequency and high-consequence interactions define immediate touch response, visual state, sound,
haptic, anticipation, confirmation, error recovery, reduced-motion equivalent, and low-resource equivalent.
Priority actions include manipulating fabric, selecting construction, accepting a tradeoff, signing an
agreement, committing production, opening a store, launching a collection, receiving results, reading Vex,
responding to Luxe, resolving a crisis, and archiving a collection.

Audio follows `AUDIO_DIRECTION_BIBLE.md`. Kingston begins with culturally reviewed dancehall/reggae
subculture, contemporary Jamaican production, Afrobeats connection where contextually valid, modern R&B,
and bass-forward street and studio energy. Global glamour expands through runway house, electronic, deep
house, orchestral couture, cinematic pop, and city-specific sound without copying reference works. Important
actions remain understandable without sound, and important audio information has a visual or haptic
equivalent.

### 18.17 Emotional pacing modes

The interface and world alternate deliberately among four modes:

| Mode | Product purpose |
|---|---|
| Work | Tactile creation and operational decisions |
| Anticipation | Sampling, delivery, preparation, uncertainty |
| Spectacle | Reveals, Gala, major arrivals, earned milestones |
| Reflection | Luxe conversations, Archive, seasonal review, recovery |

Constant urgency is prohibited. HQ may not become a field of red badges, simultaneous countdowns, animated
currencies, and prestige labels. Space, silence, restraint, and readable hierarchy are part of the luxury
fantasy.

### 18.18 Inhabited world and environmental consequence

Between decisions, customers browse, staff work, deliveries arrive, garments move, weather and time shift,
coverage appears, characters visit, stores transform, popular designs appear on people, failed stock remains
visible, and rival influence can be seen before it becomes a modal. Ambient life is bounded for performance
and has deterministic low-device substitutes.

### 18.19 House Dossier and authorship proof

The player can review a shareable, privacy-safe House Dossier containing House name and mark, founder
portrait, House Codes, signature collection, audience, reputation traits, city history, selected Vex line,
Luxe relationship state, and Archive moments. Sharing is optional and grants no competitive reward.

### 18.20 Production companion bibles

The following files contain creator-approved production direction and explicitly labeled provisional implementation recommendations for GDD v8: `PRODUCT_POSITIONING_BIBLE.md`,
`ART_DIRECTION_BIBLE.md`, `EMOTIONAL_EXPERIENCE_BIBLE.md`, `AUDIO_DIRECTION_BIBLE.md`,
`NARRATIVE_STYLE_GUIDE.md`, `COMMUNITY_TRUST_CHARTER.md`, and `NON_FEATURE_COMPLETION_GATE.md`.
...
| AI-generated dialogue and commentary | Non-authoritative trusted presentation service | Display labeled prose with fallback and report controls |
...
### 20.3 Category, emotion, and marketability validation

The product is not validated only because players can complete tasks. Research must measure whether players:

- Describe the game as a fashion-house strategy drama without prompting.
- Recognize the primary tone as aspirational and glamorous.
- Understand what makes their House distinct.
- Feel anticipation before release and earned pride or productive disappointment afterward.
- Remember Luxe, Vex, and at least one industry relationship.
- Explain one creative decision, one business decision, and one consequence.
- Voluntarily begin another Collection Cycle.
- Trust the result explanation, monetization, and recovery rules.
- Can identify The Styliste from a cropped screenshot, sound motif, or character silhouette.

External validation groups must include fashion-interested players, tycoon/simulation players, players
unfamiliar with fashion terminology, experienced mobile F2P players, accessibility testers, low-end Android
users, players resistant to dress-up games, players resistant to spreadsheets, Jamaican/Caribbean cultural
reviewers, and fashion or garment-construction reviewers.

### 20.4 Content sustainability and solo live-operation budget

A live-content package is not approved without theme, narrative purpose, reused asset inventory, new asset
requirements, engineering cost, art cost, QA cost, moderation cost, localization cost, expected lifespan,
rerun plan, retirement plan, and rollback. The target cadence is slower and editorial: one meaningful
seasonal chapter, one coherent collection theme, several reusable world consequences, one character
development, and one carefully designed event.
...
| P-05 | Fashion-house strategy drama positioning and aspirational-glamorous tone | EG | All bands | Product, art, narrative, audio, and marketing review |
| LOOP-02 | Three-look capsule and full Collection Cycle | EG prototype; A depth | First collection onward | Design, production, release, consequence, and Archive must connect |
| ROLE-01 | Two Founder Paths and Industry Role Mastery | EG definition; A playable | After Founder Trial | No profession lockout or competitive multiplier |
...
| PROD-01 | Sampling, manufacturing, quality, allocation, and production bridge | EG prototype; A depth | First capsule onward | Server authority, named counterparties, visible tradeoffs |
| BRAND-01 | House Codes and authored identity memory | EG foundation; A depth | Repeated releases | Descriptive/opportunity-shaping; no permanent score bonus |
...
| UI-11 | Signature collection reveal and House Dossier | EG prototype; A depth | First collection onward | Truthful settled results, reduced-motion and low-resource variants |
| ART-DIR-01 | Aurelian art and taste authority | EG foundation; each wave | All bands | Companion bible review and only-The-Styliste test |
| AUDIO-01 | Musical, sonic, material, and haptic identity | EG direction; A production | Matching interactions | Accessibility equivalents and performance budget |
| NARR-01 | Character voice, emotional pacing, named-person memory | EG core; A depth | FTUE onward | Evidence-grounded dialogue and mobile writing limits |
| MKT-01 | Truthful category positioning, screenshots, trailer, and release presentation | A foundation; B launch | Public surfaces | Actual-build capture and no implied unavailable features |
| TRUST-01 | Community conduct, attribution, moderation, appeals, and public trust | A policy; B production | Before player social features | Human ownership and minor protections |
| QA-01 | Non-feature completion gate and external specialist validation | EG definition; each promotion | Internal and public milestones | Evidence across taste, emotion, art, audio, trust, performance, and sustainability |
...
### 21.11 V8 completion-layer staging

V8 does not authorize simultaneous implementation of every role, relationship, season, campaign, and
production system. The additions stage as follows:

| V8 capability | Prototype / Early Game | Alpha | Beta / Launch | Post-launch |
|---|---|---|---|---|
| Collection Cycle | Three-look Kingston capsule | More briefs, sampling depth | Seasonal operation | Multi-city variation |
| Industry roles | Designer, store operator, supplier, basic buyer | Manufacturer, production planner, stylist, publicist | Wholesale buyer, advanced retail, media, school recruitment | Subculture and institution networks |
| Named people | Supplier, manufacturer, buyer, stylist/editor, three customers | Expanded recurring cast | Social and Maison-facing cast | Regional institutions and heritage |
| House Codes | Basic repeated-choice memory | Coherence and contradiction | Public Dossier and deeper reactions | Legacy interpretation |
| Reinvention | One imperfect launch and recovery | Multi-step crises | Seasonal comeback arcs | Institutional legacy repair |
| Signature reveal | One performant Kingston sequence | Variants and campaign context | Gala/social presentation | City and legacy variants |
| Audio and art bibles | Direction and prototype assets | Production pipeline | Launch-quality implementation | Expansion libraries |
| Community trust | Internal standards | Moderation/support prototype | Public policy and operations | Recertification |

The disposable Kingston proof-of-fun must include one three-look capsule, named supplier, named manufacturer,
named buyer, named stylist or editor, three customer segments, three named customers, one store, one
production problem, one imperfect result, one recovery choice, Luxe and Vex responses, and one archived
collection review. It must not include live multiplayer, monetization, broad generative AI, territory, DMs,
store trading, or a third Founder Path.
...
45. **Category comprehension:** unprompted testers accurately describe the product as a fashion-house strategy drama or an equivalent formulation.
46. **Primary tone:** testers identify the intended experience as aspirational and glamorous without reading marketing copy.
47. **Collection causality:** the player can trace each collection from brief through design, sampling, production, presentation, distribution, result, and Archive.
48. **Two paths, many roles:** Artisan and Architect remain comprehensible while no core industry role is permanently inaccessible to either path.
49. **Production bridge:** no released garment appears from nowhere; cost, quality, timing, inventory, and counterparties are visible and authoritative.
50. **Human world:** the first complete loop contains recurring named people whose reactions use actual memory and evidence.
51. **House Codes:** repeated player choices create a legible identity without granting an unfair permanent score multiplier.
52. **Comeback quality:** one meaningful failure can be diagnosed and repaired without premium rescue, account reset, or hidden punishment.
53. **Signature moment:** the collection reveal communicates garment, identity, human reaction, commercial consequence, cultural consequence, Luxe, Vex, and next action.
54. **Art distinctiveness:** major screens and assets pass the “only The Styliste” review and remain readable on the target phone.
55. **Sensory coherence:** touch, motion, sound, haptic, and fallback behavior are authored for priority interactions.
56. **Pacing:** Work, Anticipation, Spectacle, and Reflection are all present; the UI does not sustain constant urgency.
57. **Environmental consequence:** at least three player decisions visibly alter the Atelier, store, customers, staff, or world between menus.
58. **Authorship proof:** the player can explain what their House believes, who it serves, and which collection defined it.
59. **Marketability:** a truthful thirty-second capture of actual gameplay communicates the hook without explanatory narration.
60. **Sustainability:** the solo developer can create, verify, operate, and retire the content without exceeding the declared cost and maintenance budget.
61. **Community trust:** public social features cannot launch without published conduct, attribution, reporting, appeals, minor protections, and moderation ownership.
62. **External review:** Kingston receives fashion, garment-construction, Jamaican/Caribbean cultural, accessibility, and low-end-device review before public launch.
...
- **Fashion-House Strategy Drama:** The product category combining creative authorship, commercial management, relationships, and remembered consequences.
- **Collection Cycle:** The macro loop from cultural and market reading through brief, design, production, presentation, release, consequence, Archive, and seasonal review.
- **Founder Path:** Artisan or Architect; the initial point of view and mastery curve selected during the Founder Trial.
- **Industry Role:** A specialized fashion-world function available through direction, staff, automation, contracts, collaboration, or personal mastery.
- **Role Mastery:** Progression that unlocks information and choices within an Industry Role without increasing competitive ceilings.
- **House Codes:** The mechanically legible design, commercial, ethical, cultural, and relationship patterns established by repeated player behavior.
- **Production Bridge:** The authoritative process connecting approved design to sampling, manufacturing, inspection, allocation, and release.
- **Signature Reveal:** The recurring collection-result sequence combining fashion, character, commercial, cultural, and Archive consequences.
- **Aspirational Glamour:** The primary emotional tone of possibility, transformation, desirability, authorship, and earned prestige.
- **Editorial Cadence:** A sustainable live-content rhythm favoring coherent, meaningful packages over constant volume.
- **Non-Feature Completion Gate:** The release standard covering identity, taste, emotion, art, audio, writing, game feel, trust, reliability, accessibility, marketability, and sustainability.

## 24. Version 7 Changelog — Historical
...
## 25. Version 8 Changelog

Version 8 preserves all binding v7 security, fairness, server-authority, accessibility, solo-development,
implementation-wave, and feature-flag constraints while adding the product-completion layer required for
The Styliste to compete as an authored fashion experience rather than a catalogue of systems.

### Added

- The creator-approved core fantasy: **I built my own luxury fashion empire**, with luxury fashion empire simulation as the player-facing position and fashion-house strategy drama as an internal production description.
- **Aspirational and glamorous** as the primary tone, with the creator-approved secondary hierarchy:
  mature and dramatic; sharp and satirical; competitive and intense; warm and character-led; mysterious
  and prestigious; playful and humorous; relaxing and comforting.
- Young adults as the primary audience and realistic fashion-industry grounding with heightened drama.
- Researched city-specific visual dialects, including stylized editorial Milan and anime-influenced Tokyo,
  under one Aurelian identity.
- Creator-approved Kingston, Luxe, Vex, Seraphine Vale, audio, and product-boundary direction.
- The **Collection Cycle** as the macro loop connecting design, production, presentation, commerce,
  relationships, consequences, and Archive.
- A three-look Kingston capsule as the proof-of-fun collection scope.
- **Two Founder Paths, many Industry Roles**, including Role Mastery and a third-path validation gate.
- A playable production bridge with sampling, manufacturer selection, quality, quantity, timing, and stock
  allocation.
- Named recurring customers and fashion-industry counterparties layered over population simulation.
- **House Codes** as descriptive identity memory.
- Reinvention and comeback gameplay.
- A humane fashion-season calendar.
- Styling, campaign, and editorial interpretation.
- The signature collection reveal, House Dossier, inhabited-world contract, sensory identity, and four-mode
  pacing language.
- Category, emotional, marketability, sustainability, and external-review analytics gates.
- Creator-approved companion production authorities for positioning, art, emotion, audio, writing, community
  trust, and non-feature completion.
- New feature IDs: `P-05`, `LOOP-02`, `ROLE-01`, `PROD-01`, `BRAND-01`, `UI-11`, `ART-DIR-01`,
  `AUDIO-01`, `NARR-01`, `MKT-01`, `TRUST-01`, and `QA-01`.

### Clarified

- The player-facing fantasy leads with building a luxury fashion empire; the internal strategy-drama label
  supports production but does not replace that fantasy.
- The world is realistic with heightened drama rather than fully realistic, futuristic, or theatrical fantasy.
- Visual treatment may vary by city when researched, culturally reviewed, and unified by Aurelian production
  rules.
- Artisan and Architect are starting Founder Paths, not the complete set of playable fashion-world roles.
- Glamour is a product emotion and presentation discipline, not an excuse for manipulative reward design or
  gold decoration on every surface.
- The Styliste competes through consequence, authorship, fashion literacy, emotional maturity, fairness,
  and remembered House history rather than content volume.
- No new V8 capability bypasses the solo-first work-in-progress limit or authorizes deferred multiplayer,
  monetization, territory, DMs, trading, broad generative AI, or a third Founder Path.
