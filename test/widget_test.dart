...
void main() {
  testWidgets('auth gate renders while Supabase sign-in is pending', (
    WidgetTester tester,
  ) async {
    final Completer<Session> pendingSignIn = Completer<Session>();

    await tester.pumpWidget(
      ProviderScope(
        overrides: <Override>[
          supabaseAnonSignInProvider.overrideWith(
