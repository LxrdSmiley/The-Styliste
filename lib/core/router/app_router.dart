...
import '../../features/onboarding/screens/obsidian_gate_screen.dart';
...
abstract final class AppRouter {
  // --- Route names ---
  static const String onboardingObsidianGate = '/onboarding/obsidian-gate';
  ...
  static final GoRouter router = GoRouter(
    initialLocation: onboardingObsidianGate,
    routes: <RouteBase>[
      // --- Onboarding (GDD §1.1) ---
      GoRoute(
        path: onboardingObsidianGate,
        builder: (BuildContext context, GoRouterState state) =>
            const ObsidianGateScreen(),
      ),
      GoRoute(
